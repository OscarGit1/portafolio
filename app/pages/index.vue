    ...
    <nav class="navbar">
      <div class="nav-content container">
        ...
        <div class="nav-links">
          ...
          <a :href="withBase('/Oscar_Jimenez_Reyes_Full_Stack_Developer_CV.pdf')" target="_blank" class="nav-cv-btn" download="Oscar_Jimenez_Reyes_CV.pdf">CV</a>
    ...
    <section class="hero container animate-in">
      <div class="hero-content">
        ...
        <div class="hero-actions">
          ...
          <a :href="withBase('/Oscar_Jimenez_Reyes_Full_Stack_Developer_CV.pdf')" target="_blank" class="btn btn-cv" download="Oscar_Jimenez_Reyes_CV.pdf">
